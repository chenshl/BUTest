...
class BU_wallet_v1(unittest.TestCase):
    """BU钱包内嵌版"""
    def setUp(self):
        self.token = "eyJhbGciOiJIUzI1NiJ9.eyJpYXQiOjE1Mjk2NTMxNDIsInN1YiI6IndhbGxldOezu-e7nyIsInBhcnRuZXJJZCI6ImNhZWIyZjEzN2RkNTgxYmY4ZjExYTNhMmJjMTkwYjU4IiwidXNlck1vYmlsZSI6IjE4NzE2MjAwMDA3In0.1qDDU8Ra8E5y91V8aBgi2R06JYRsLq-oouaByLfb07s"
        # 正式token
